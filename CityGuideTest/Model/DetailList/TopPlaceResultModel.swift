//
//  TopPlaceResultModel.swift
//  CityGuideTest
//
//  Created by Kinlive on 2017/11/27.
...
struct TopPlaceResultModel{
    
    ///CityDetailListModel's singleton.
    private static var shared: TopPlaceResultModel = {
        
        let standard = TopPlaceResultModel(topPlaceResultList: [])
        
        return standard
    }()
    
    ///Get CityDetailListModel standard singleton.
    static func standard() -> TopPlaceResultModel{
    ...
    var topPlaceResultList: [TopPlaceResultObject]
    
    
    func toString(){
        
        print("總數：\(topPlaceResultList.count)")
...
struct TopPlaceResultObject{
    ...
    init(json: [String: Any]){
        ...
        self.img = TopPlaceResultObject.handleStringToArray(jsonStr: json["img"] as? String ?? "")
        
        self.imgTitle = json["imgtitle"] as? String ?? ""
        self.content = json["content"] as? String ?? ""
        self.summary = json["summary"] as? String ?? ""
        
        let poiArray = TopPlaceResultObject.handleStringToArray(jsonStr: json["poi"] as? String ?? "")
        self.poi = poiArray
        ...
        self.youtube = TopPlaceResultObject.handleTheYoutubeJson(jsonStr: json["youtube"] as? String ?? "")
        
        self.guideMap = TopPlaceResultObject.handleStringToArray(jsonStr: json["guidemap"] as? String ?? "")
