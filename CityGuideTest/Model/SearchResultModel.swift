...
struct SearchResultModel{
    ...
    private static var shared: SearchResultModel = {
        
        let standard = SearchResultModel(searchResultList: [])
        
        return standard
    }()
    
    ///Get CityDetailListModel standard singleton.
    static func standard() -> SearchResultModel{
    ...
    func toString(){
        ...
        print("總數：\(searchResultList.count)")
...
struct SearchResultObject{
    ...
    init(json: [String: Any]){
        ...
        self.img = SearchResultObject.handleStringToArray(jsonStr: json["img"] as? String ?? "")
        
        self.imgTitle = json["imgtitle"] as? String ?? ""
        self.content = json["content"] as? String ?? ""
        self.summary = json["summary"] as? String ?? ""
        
        let poiArray = SearchResultObject.handleStringToArray(jsonStr: json["poi"] as? String ?? "")
        self.poi = poiArray
        ...
        self.youtube = SearchResultObject.handleTheYoutubeJson(jsonStr: json["youtube"] as? String ?? "")
        
        self.guideMap = SearchResultObject.handleStringToArray(jsonStr: json["guidemap"] as? String ?? "")
